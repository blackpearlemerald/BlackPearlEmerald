...
| Black Pearl Emerald 2.0.0-beta / 2.0.1 (local CLI) | 3 | supported | ROM hash or explicit profile | supported, including BPE packing | supported | supported | all persistent bits and symbols | expanded seen/caught bits | supported | Exact BPE release commits plus compiled DWARF layouts |
