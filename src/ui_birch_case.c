...
struct MonChoiceData{ // This is the format used to define a mon, everything left out will default to 0 and be blank or use the in game defaults
    ...
    u8 ivs[6]; // fixed IV per stat (0-31), or USE_RANDOM_IVS to roll it like a normal wild mon
...
{
    [BALL_TOP_FIRST]        = {SPECIES_RALTS, 5, 0, BALL_POKE, NATURE_RANDOM, NUM_ABILITY_PERSONALITY, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS}, {MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT}, 0, 0, 0},
    [BALL_TOP_SECOND]       = {SPECIES_HONEDGE, 5, 0, BALL_POKE, NATURE_RANDOM, NUM_ABILITY_PERSONALITY, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS}, {MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT}, 0, 0, 0},
    [BALL_MIDDLE_FIRST]     = {SPECIES_TORCHIC, 5, 0, BALL_POKE, NATURE_RANDOM, NUM_ABILITY_PERSONALITY, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS}, {MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT}, 0, 0, 0},

    [BALL_TOP_THIRD]        = {SPECIES_WOOPER_PALDEAN, 5, 0, BALL_POKE, NATURE_RANDOM, NUM_ABILITY_PERSONALITY, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS}, {MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT}, 0, 0, 0},
    [BALL_TOP_FOURTH]       = {SPECIES_PORYGON, 5, 0, BALL_POKE, NATURE_RANDOM, NUM_ABILITY_PERSONALITY, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS}, {MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT}, 0, 0, 0},
    [BALL_MIDDLE_THIRD]     = {SPECIES_TREECKO, 5, 0, BALL_POKE, NATURE_RANDOM, NUM_ABILITY_PERSONALITY, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS}, {MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT}, 0, 0, 0},

    [BALL_MIDDLE_SECOND]    = {SPECIES_MUDKIP, 5, 0, BALL_POKE, NATURE_RANDOM, NUM_ABILITY_PERSONALITY, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS}, {MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT}, 0, 0, 0},
    [BALL_BOTTOM_FIRST]     = {SPECIES_EEVEE, 5, 0, BALL_POKE, NATURE_RANDOM, NUM_ABILITY_PERSONALITY, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS}, {MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT}, 0, 0, 0},
    [BALL_BOTTOM_SECOND]    = {SPECIES_VULPIX_ALOLAN, 5, 0, BALL_POKE, NATURE_RANDOM, NUM_ABILITY_PERSONALITY, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS, USE_RANDOM_IVS}, {MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT, MOVE_DEFAULT}, 0, 0, 0},
};
