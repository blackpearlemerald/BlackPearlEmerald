...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_URSARING] =
    {
        ...
        // BPE: Hisui's full moon is any night in Hoenn. A Peat Block used at any
        // other time gives the Bloodmoon form, which had no way into the game.
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_PEAT_BLOCK, SPECIES_URSALUNA, CONDITIONS({IF_TIME, TIME_NIGHT})},
                                {EVO_ITEM, ITEM_PEAT_BLOCK, SPECIES_URSALUNA_BLOODMOON, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})}),
    #endif
    },
