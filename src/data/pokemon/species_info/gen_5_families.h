...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_BASCULIN_WHITE_STRIPED] =
    {
        ...
        .formSpeciesIdTable = sBasculinFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_BASCULEGION_M, CONDITIONS({IF_RECOIL_DAMAGE_GE, 1}, {IF_GENDER, MON_MALE})},
                                {EVO_LEVEL, 0, SPECIES_BASCULEGION_F, CONDITIONS({IF_RECOIL_DAMAGE_GE, 1}, {IF_GENDER, MON_FEMALE})}),
    },
    ...
    [SPECIES_YAMASK_GALAR] =
    {
        ...
        .formSpeciesIdTable = sYamaskFormSpeciesIdTable,
        // BPE: no map has the Dusty Bowl arch that sets off EVO_TRIGGER_TABLET_CURSE, so
        // it evolves on level-up instead, at Yamask's level, while down 49+ HP.
