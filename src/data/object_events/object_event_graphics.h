...
const u32 gObjectEventPic_Wake[] = INCGFX_U32("graphics/object_events/pics/people/wake.png", ".4bpp", "-mwidth 2 -mheight 4");
const u16 gObjectEventPalette_Wake[] = INCGFX_U16("graphics/object_events/pics/people/wake.png", ".gbapal");
