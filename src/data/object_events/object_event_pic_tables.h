...
const struct SpriteFrameImage gObjectEventPicTable_Pants[] = {
    overworld_frame(gObjectEventPic_Pants, 2, 4, 0),
    overworld_frame(gObjectEventPic_Pants, 2, 4, 1),
    overworld_frame(gObjectEventPic_Pants, 2, 4, 2),
    overworld_frame(gObjectEventPic_Pants, 2, 4, 3),
    overworld_frame(gObjectEventPic_Pants, 2, 4, 4),
    overworld_frame(gObjectEventPic_Pants, 2, 4, 5),
    overworld_frame(gObjectEventPic_Pants, 2, 4, 6),
    overworld_frame(gObjectEventPic_Pants, 2, 4, 7),
...
static const struct SpriteFrameImage sPicTable_Shauntal[] = {
    overworld_ascending_frames(gObjectEventPic_Shauntal, 4, 4),
};

static const struct SpriteFrameImage sPicTable_Grimsley[] = {
    overworld_ascending_frames(gObjectEventPic_Grimsley, 4, 4),
};
