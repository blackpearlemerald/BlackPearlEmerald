...
u8 HasWildPokmnOnThisRouteBeenSeen(u8 currLocation, bool8 setVarForThisEnc) {
    ...
    case MAPSEC_TRICK_HOUSE_1:
        varToCheck = 4;
        bitToCheck = 11;
        break;
    case MAPSEC_TRICK_HOUSE_2:
        varToCheck = 4;
        bitToCheck = 12;
        break;
    case MAPSEC_TRICK_HOUSE_3:
        varToCheck = 4;
        bitToCheck = 13;
        break;
    case MAPSEC_TRICK_HOUSE_4:
        varToCheck = 4;
        bitToCheck = 14;
        break;
    case MAPSEC_TRICK_HOUSE_5:
        varToCheck = 4;
        bitToCheck = 15;
        break;
    case MAPSEC_TRICK_HOUSE_6:
        varToCheck = 5;
        bitToCheck = 0;
        break;
    case MAPSEC_TRICK_HOUSE_7:
        varToCheck = 5;
        bitToCheck = 1;
        break;
    case MAPSEC_TRICK_HOUSE_8:
        varToCheck = 5;
        bitToCheck = 2;
        break;
    case MAPSEC_VICTORY_ROAD_2:
        varToCheck = 5;
        bitToCheck = 3;
        break;
    case MAPSEC_VICTORY_ROAD_3:
        varToCheck = 5;
        bitToCheck = 4;
        break;
