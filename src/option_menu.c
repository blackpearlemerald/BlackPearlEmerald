...
void CB2_InitOptionMenu(void)
{
    ...
    case 10:
    {
        ...
        gTasks[taskId].tBattleStyle = FlagGet(FLAG_NUZLOCKE) ? OPTIONS_BATTLE_STYLE_SET : gSaveBlock2Ptr->optionsBattleStyle;
...
// BPE: Battle Style can be changed in Standard mode; Nuzlocke mode is locked to SET.
static u8 BattleStyle_ProcessInput(u8 selection)
{
