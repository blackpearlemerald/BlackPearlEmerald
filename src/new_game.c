...
{
    gSaveBlock2Ptr->optionsTextSpeed = OPTIONS_TEXT_SPEED_FAST; // BPE: FAST by default
    gSaveBlock2Ptr->optionsWindowFrameType = 0;
    gSaveBlock2Ptr->optionsSound = OPTIONS_SOUND_MONO;
    gSaveBlock2Ptr->optionsBattleStyle = OPTIONS_BATTLE_STYLE_SET; // BPE: SET by default
...
void NewGameInitData(void)
{
    ...
    struct RandomizerSettings randomizer; // BPE: the randomizer is chosen during Birch speech too
#if IS_FRLG
    ...
    Randomizer_LoadSettings(&randomizer);
#if IS_FRLG
