...
#define B_BATTLE_BOND               GEN_8      // In Gen9+, Battle Bond increases Atk, SpAtk and Speed by one stage, once per battle. BPE: GEN_8 turns Greninja into Ash-Greninja instead, so that form can be seen.
