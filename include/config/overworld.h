...
#define OW_PC_HEAL                  GEN_9      // In Gen8+, Pokémon are not healed when deposited in the PC.
...
#define OW_FLAG_NO_ENCOUNTER        0x8E7  // If this flag is set, wild encounters will be disabled.
#define OW_FLAG_NO_TRAINER_SEE      0x8E8  // If this flag is set, trainers will not battle the player unless they're talked to.
#define OW_FLAG_NO_COLLISION        0x8E9  // If this flag is set, the player will be able to walk over tiles with collision. Mainly intended for debugging purposes.
