...
// BPE: fishing always succeeds. The bite odds are fixed at 100% in src/fishing.c, and the Gen 1/2
// minigame has no reel timeout and cannot be cancelled early, so a hooked Pokémon never gets away.
#define I_FISHING_BITE_ODDS         GEN_LATEST // BPE: ignored, see above. In Gen 1 and Gen 2, the Old Rod has a 100% chance for a bite, Good Rod has a 66% chance for a bite, and Super Rod has a 50% chance for a bite. In Gen 3, all rods have a base 50% chance for a bite. In Gen 4 onwards, the Old Rod has a base 25% chance for a bite, Good Rod has a 50% chance for a bite, and Super Rod has a 75% chance for a bite.
#define I_FISHING_MINIGAME          GEN_1      // BPE: GEN_1 so a hooked Pokémon can't get away. Each generation uses a variation of reeling in Pokémon once they have been hooked. NOTE: Only the Gen 1/2 and Gen 3 minigames are implemented right now!
