...
#define VAR_RANDOMIZER_SEED_LO                           0x404E // BPE randomizer: seed, low 16 bits
...
#define VAR_RANDOMIZER_SEED_HI                           0x4083 // BPE randomizer: seed, high 16 bits
...
#define VAR_ISLAND_LEGENDARY                            0x408B // Legendary Lottery Island: current resident legendary species
#define VAR_LITTLEROOT_HOUSES_STATE_BRENDAN              0x408C
#define VAR_LITTLEROOT_RIVAL_STATE                       0x408D
#define VAR_BOARD_BRINEY_BOAT_STATE                      0x408E
#define VAR_DEVON_CORP_3F_STATE                          0x408F
#define VAR_BRINEY_HOUSE_STATE                           0x4090
#define VAR_RANDOMIZER_OPTIONS_0                         0x4091 // BPE randomizer: option bits 0-15
...
#define VAR_RANDOMIZER_OPTIONS_1                         0x409B // BPE randomizer: option bits 16-31
#define VAR_ELITE_4_STATE                                0x409C
#define VAR_RANDOMIZER_OPTIONS_2                         0x409D // BPE randomizer: option bits 32-35, algorithm version, HM fallback
#define VAR_MOSSDEEP_SPACE_CENTER_STAIR_GUARD_STATE      0x409E
#define VAR_MOSSDEEP_SPACE_CENTER_STATE                  0x409F
#define VAR_SLATEPORT_HARBOR_STATE                       0x40A0
#define VAR_STARTER_SPECIES                              0x40A1 // BPE: the species picked from the Birch Case
...
#define VAR_REGISTERED_ITEM_2                            0x40A8 // BPE: second SELECT-registered item
...
#define VAR_REGISTERED_ITEM_3                            0x40B8 // BPE: third SELECT-registered item
#define VAR_MT_PYRE_STATE                                0x40B9
#define VAR_NEW_MAUVILLE_STATE                           0x40BA
#define VAR_REGISTERED_ITEM_4                            0x40BB // BPE: fourth SELECT-registered item
...
#define VAR_DEXNAV_SPECIES                               0x40DB // BPE: DexNav registered species (bits 0-13) and area (bits 14-15)
#define VAR_DEXNAV_STEP_COUNTER                          0x40DC // BPE: DexNav steps towards the next hidden Pokémon check
...
#define VAR_REGISTERED_ITEM_5                            0x40E5 // BPE: fifth SELECT-registered item
...
#define VAR_WILD_PKMN_ROUTE_SEEN_5                       0x40FC
#define VAR_PREE4_LEGENDARY                              0x40FD // BPE: no longer set; pre-Elite Four catches use FLAG_CAUGHT_PREE4_*
