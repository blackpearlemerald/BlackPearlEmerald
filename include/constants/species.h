...
// BPE compatibility aliases: long regional form names → short upstream names
// Alolan forms (_ALOLAN → _ALOLA)
...
// Galarian forms (_GALARIAN → _GALAR)
...
#define SPECIES_DARMANITAN_GALARIAN         SPECIES_DARMANITAN_GALAR
#define SPECIES_DARMANITAN_GALARIAN_STANDARD_MODE  SPECIES_DARMANITAN_GALAR_STANDARD
...
// Paldean forms (_PALDEAN → _PALDEA)
...
// Floral/trim form renames (1.11.3)
#define SPECIES_VIVILLON_POKE_BALL          SPECIES_VIVILLON_POKEBALL
#define SPECIES_FLABEBE_YELLOW_FLOWER       SPECIES_FLABEBE_YELLOW
#define SPECIES_FLABEBE_ORANGE_FLOWER       SPECIES_FLABEBE_ORANGE
#define SPECIES_FLABEBE_BLUE_FLOWER         SPECIES_FLABEBE_BLUE
#define SPECIES_FLABEBE_WHITE_FLOWER        SPECIES_FLABEBE_WHITE
#define SPECIES_FLOETTE_YELLOW_FLOWER       SPECIES_FLOETTE_YELLOW
#define SPECIES_FLOETTE_ORANGE_FLOWER       SPECIES_FLOETTE_ORANGE
#define SPECIES_FLOETTE_BLUE_FLOWER         SPECIES_FLOETTE_BLUE
#define SPECIES_FLOETTE_WHITE_FLOWER        SPECIES_FLOETTE_WHITE
#define SPECIES_FLOETTE_ETERNAL_FLOWER      SPECIES_FLOETTE_ETERNAL
#define SPECIES_FLORGES_YELLOW_FLOWER       SPECIES_FLORGES_YELLOW
#define SPECIES_FLORGES_ORANGE_FLOWER       SPECIES_FLORGES_ORANGE
#define SPECIES_FLORGES_BLUE_FLOWER         SPECIES_FLORGES_BLUE
#define SPECIES_FLORGES_WHITE_FLOWER        SPECIES_FLORGES_WHITE
#define SPECIES_FURFROU_HEART_TRIM          SPECIES_FURFROU_HEART
#define SPECIES_FURFROU_STAR_TRIM           SPECIES_FURFROU_STAR
#define SPECIES_FURFROU_DIAMOND_TRIM        SPECIES_FURFROU_DIAMOND
#define SPECIES_FURFROU_DEBUTANTE_TRIM      SPECIES_FURFROU_DEBUTANTE
#define SPECIES_FURFROU_MATRON_TRIM         SPECIES_FURFROU_MATRON
#define SPECIES_FURFROU_DANDY_TRIM          SPECIES_FURFROU_DANDY
#define SPECIES_FURFROU_LA_REINE_TRIM       SPECIES_FURFROU_LA_REINE
#define SPECIES_FURFROU_KABUKI_TRIM         SPECIES_FURFROU_KABUKI
#define SPECIES_FURFROU_PHARAOH_TRIM        SPECIES_FURFROU_PHARAOH
#define SPECIES_MEOWSTIC_FEMALE             SPECIES_MEOWSTIC_F
// Squawkabilly plumage aliases (upstream uses _PLUMAGE suffix, BPE uses short forms)
