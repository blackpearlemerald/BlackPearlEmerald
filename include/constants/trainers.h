...
#define TRAINER_ENCOUNTER_MUSIC_MALE         0 // Used for Youngsters, Bug Catchers, male School Kids, Sailors, male running and cycling Triathletes, male Pok̩mon Breeders, and Campers
#define TRAINER_ENCOUNTER_MUSIC_FEMALE       1 // Used for Lasses, Ladies, Beauties, Aroma Ladies, female running and cycling Triathletes, female Pok̩mon Breeders, and Parasol Ladies
#define TRAINER_ENCOUNTER_MUSIC_GIRL         2 // Used for Tubers, Picnickers, female School Kids, and Young Couples
#define TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS   3 // Used for Ninja Boys, Collectors, Hex Maniacs, Pok̩ Maniacs, and Bug Maniacs
...
#define TRAINER_ENCOUNTER_MUSIC_COOL         5 // Used for Cool Trainers, Pok̩mon Rangers, and Bird Keepers
...
#define TRAINER_ENCOUNTER_MUSIC_TWINS        9 // Used for Twins, Pok̩ Fans, and Sr. and Jr.s
