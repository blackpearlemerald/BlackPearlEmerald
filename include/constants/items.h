...
enum __attribute__((packed)) Item
{
    ...
    ITEM_CATCHING_CHARM = 834,
    ITEM_EXP_CHARM = 835,

    // Form-changing Key Items
    ITEM_ROTOM_CATALOG = 836,
    ITEM_GRACIDEA = 837,
    ITEM_REVEAL_GLASS = 838,
    ITEM_DNA_SPLICERS = 839,
    ITEM_ZYGARDE_CUBE = 840,
    ITEM_PRISON_BOTTLE = 841,
    ITEM_N_SOLARIZER = 842,
    ITEM_N_LUNARIZER = 843,
    ITEM_REINS_OF_UNITY = 844,

    // Battle Mechanic Key Items
    ITEM_MEGA_RING = 845,
    ITEM_Z_POWER_RING = 846,
    ITEM_DYNAMAX_BAND = 847,
    ...
    ITEM_GOOD_ROD = 852,
    ITEM_SUPER_ROD = 853,
    ITEM_DOWSING_MACHINE = 854,
    ITEM_ITEMFINDER = ITEM_DOWSING_MACHINE, // Pre-Gen IV name
    ITEM_DOWSING_MCHN = ITEM_DOWSING_MACHINE, // Gen IV-V name
    ITEM_TOWN_MAP = 855,
    ITEM_VS_SEEKER = 856,
    ITEM_TM_CASE = 857,
    ITEM_BERRY_POUCH = 858,
    ITEM_POKEMON_BOX_LINK = 859,
    ITEM_POKEMON_BOX = ITEM_POKEMON_BOX_LINK, // Pre-Gen VIII name
    ITEM_COIN_CASE = 860,
    ITEM_POWDER_JAR = 861,
    ITEM_WAILMER_PAIL = 862,
    ITEM_POKE_RADAR = 863,
    ITEM_POKEBLOCK_CASE = 864,
    ITEM_SOOT_SACK = 865,
    ITEM_POKE_FLUTE = 866,
    ITEM_FAME_CHECKER = 867,
    ITEM_TEACHY_TV = 868,

    // Story Key Items
    ITEM_SS_TICKET = 869,
    ITEM_EON_TICKET = 870,
    ITEM_MYSTIC_TICKET = 871,
    ITEM_AURORA_TICKET = 872,
    ITEM_OLD_SEA_MAP = 873,
    ITEM_LETTER = 874,
    ITEM_DEVON_PARTS = 875,
    ITEM_DEVON_GOODS = ITEM_DEVON_PARTS, // Pre-Gen VI name
    ITEM_GO_GOGGLES = 876,
    ITEM_DEVON_SCOPE = 877,
    ITEM_BASEMENT_KEY = 878,
    ITEM_SCANNER = 879,
    ITEM_STORAGE_KEY = 880,
    ITEM_KEY_TO_ROOM_1 = 881,
    ITEM_RM_1_KEY = ITEM_KEY_TO_ROOM_1, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_2 = 882,
    ITEM_RM_2_KEY = ITEM_KEY_TO_ROOM_2, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_4 = 883,
    ITEM_RM_4_KEY = ITEM_KEY_TO_ROOM_4, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_6 = 884,
    ITEM_RM_6_KEY = ITEM_KEY_TO_ROOM_6, // Pre-Gen VI name
    ITEM_METEORITE = 885,
    ITEM_MAGMA_EMBLEM = 886,
    ITEM_CONTEST_PASS = 887,
    ITEM_PARCEL = 888,
    ...
    ITEM_TRI_PASS = 895,
    ITEM_RAINBOW_PASS = 896,
    ITEM_TEA = 897,
    ITEM_RUBY = 898,
    ITEM_SAPPHIRE = 899,

    // GEN IX ITEMS
    ITEM_ABILITY_SHIELD = 900,
    ITEM_CLEAR_AMULET = 901,
    ITEM_PUNCHING_GLOVE = 902,
    ITEM_COVERT_CLOAK = 903,
    ITEM_LOADED_DICE = 904,
    ITEM_AUSPICIOUS_ARMOR = 905,
    ITEM_BOOSTER_ENERGY = 906,
    ITEM_BIG_BAMBOO_SHOOT = 907,
    ITEM_GIMMIGHOUL_COIN = 908,
    ITEM_LEADERS_CREST = 909,
    ITEM_MALICIOUS_ARMOR = 910,
    ITEM_MIRROR_HERB = 911,
    ITEM_SCROLL_OF_DARKNESS = 912,
    ITEM_SCROLL_OF_WATERS = 913,
    ITEM_TERA_ORB = 914,
    ITEM_TINY_BAMBOO_SHOOT = 915,

    ITEM_BUG_TERA_SHARD = 916,
    ITEM_DARK_TERA_SHARD = 917,
    ITEM_DRAGON_TERA_SHARD = 918,
    ITEM_ELECTRIC_TERA_SHARD = 919,
    ITEM_FAIRY_TERA_SHARD = 920,
    ITEM_FIGHTING_TERA_SHARD = 921,
    ITEM_FIRE_TERA_SHARD = 922,
    ITEM_FLYING_TERA_SHARD = 923,
    ITEM_GHOST_TERA_SHARD = 924,
    ITEM_GRASS_TERA_SHARD = 925,
    ITEM_GROUND_TERA_SHARD = 926,
    ITEM_ICE_TERA_SHARD = 927,
    ITEM_NORMAL_TERA_SHARD = 928,
    ITEM_POISON_TERA_SHARD = 929,
    ITEM_PSYCHIC_TERA_SHARD = 930,
    ITEM_ROCK_TERA_SHARD = 931,
    ITEM_STEEL_TERA_SHARD = 932,
    ITEM_WATER_TERA_SHARD = 933,

    ITEM_ADAMANT_CRYSTAL = 934,
    ITEM_GRISEOUS_CORE = 935,
    ITEM_LUSTROUS_GLOBE = 936,

    ITEM_BLACK_AUGURITE = 937,
    ITEM_LINKING_CORD = 938,
    ITEM_PEAT_BLOCK = 939,
    ITEM_BERSERK_GENE = 940,

    ITEM_FAIRY_FEATHER = 941,
    ITEM_SYRUPY_APPLE = 942,
    ITEM_UNREMARKABLE_TEACUP = 943,
    ITEM_MASTERPIECE_TEACUP = 944,
    ITEM_CORNERSTONE_MASK = 945,
    ITEM_WELLSPRING_MASK = 946,
    ITEM_HEARTHFLAME_MASK = 947,
    ITEM_HEALTH_MOCHI = 948,
    ITEM_MUSCLE_MOCHI = 949,
    ITEM_RESIST_MOCHI = 950,
    ITEM_GENIUS_MOCHI = 951,
    ITEM_CLEVER_MOCHI = 952,
    ITEM_SWIFT_MOCHI = 953,
    ITEM_FRESH_START_MOCHI = 954,
    ITEM_GLIMMERING_CHARM = 955,
    ITEM_METAL_ALLOY = 956,
    ITEM_STELLAR_TERA_SHARD = 957,

    ITEM_JUBILIFE_MUFFIN = 958,
    ITEM_REMEDY = 959,
    ITEM_FINE_REMEDY = 960,
    ITEM_SUPERB_REMEDY = 961,
    ITEM_AUX_EVASION = 962,
    ITEM_AUX_GUARD = 963,
    ITEM_AUX_POWER = 964,
    ITEM_AUX_POWERGUARD = 965,
    ITEM_CHOICE_DUMPLING = 966,
    ITEM_SWAP_SNACK = 967,
    ITEM_TWICE_SPICED_RADISH = 968,
    ITEM_POKESHI_DOLL = 969,
    ITEM_CANDY_JAR = 970,
    ITEM_POKEVIAL = 971,
    ITEM_TAXI_TICKET = 972,
    ITEM_POCKET_WATCH = 973,
    ITEM_EVO_CHARM = 974,
    ITEM_STRANGE_BALL = 975, // PLA ball used when Pokémon is transferred from Legends: Arceus

    ITEM_CLEFABLITE = 976,
    ITEM_VICTREEBELITE = 977,
    ITEM_STARMINITE = 978,
    ITEM_DRAGONINITE = 979,
    ITEM_MEGANIUMITE = 980,
    ITEM_FERALIGITE = 981,
    ITEM_SKARMORITE = 982,
    ITEM_FROSLASSITE = 983,
    ITEM_EMBOARITE = 984,
    ITEM_EXCADRITE = 985,
    ITEM_SCOLIPITE = 986,
    ITEM_SCRAFTINITE = 987,
    ITEM_EELEKTROSSITE = 988,
    ITEM_CHANDELURITE = 989,
    ITEM_CHESNAUGHTITE = 990,
    ITEM_DELPHOXITE = 991,
    ITEM_GRENINJITE = 992,
    ITEM_PYROARITE = 993,
    ITEM_FLOETTITE = 994,
    ITEM_MALAMARITE = 995,
    ITEM_BARBARACITE = 996,
    ITEM_DRAGALGITE = 997,
    ITEM_HAWLUCHANITE = 998,
    ITEM_ZYGARDITE = 999,
    ITEM_DRAMPANITE = 1000,
    ITEM_FALINKSITE = 1001,


    // Legends Z-A: Mega Dimension DLC Mega Stones (new in 1.15.0, renumbered for BPE)
    ITEM_HEATRANITE = 1002,
    ITEM_DARKRANITE = 1003,
    ITEM_ZERAORITE = 1004,
    ITEM_RAICHUNITE_X = 1005,
    ITEM_RAICHUNITE_Y = 1006,
    ITEM_CHIMECHITE = 1007,
    ITEM_ABSOLITE_Z = 1008,
    ITEM_STARAPTITE = 1009,
    ITEM_GARCHOMPITE_Z = 1010,
    ITEM_LUCARIONITE_Z = 1011,
    ITEM_GOLURKITE = 1012,
    ITEM_MEOWSTICITE = 1013,
    ITEM_CRABOMINITE = 1014,
    ITEM_GOLISOPITE = 1015,
    ITEM_MAGEARNITE = 1016,
    ITEM_SCOVILLAINITE = 1017,
    ITEM_BAXCALIBRITE = 1018,
    ITEM_TATSUGIRINITE = 1019,
    ITEM_GLIMMORANITE = 1020,
    ITEM_LEVEL_LIMITER = 1021, // BPE
    ITEM_INFINITE_REPEL = 1022, // BPE
