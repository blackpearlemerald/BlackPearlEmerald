...
// BPE custom NPC sprites (renumbered to avoid collision with FRLG IDs 243-387)
#define OBJ_EVENT_GFX_WAKE                       388
#define OBJ_EVENT_GFX_CYNTHIA                    389
#define OBJ_EVENT_GFX_PANTS                      390
