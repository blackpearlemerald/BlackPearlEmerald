...
1. Revert trainer locations to original game (keep teams, just remove forced trainer battles on every route) — COMPLETE for all routes (Routes 113–134; Route 122 is water-only, no trainers; Routes 132 and 133 were already correct)
